...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
             ...
             * data objek pajak
             */
            'op_kd_kecamatan'       => 'required|exists:ref_kecamatan,KD_KECAMATAN',
            'op_kd_kelurahan'       => 'required|exists:ref_kelurahan,KD_KELURAHAN',
            'op_kd_blok'            => 'required|exists:dat_peta_blok,KD_BLOK',
