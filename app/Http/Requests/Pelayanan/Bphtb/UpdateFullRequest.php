...
class UpdateFullRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'npopkp'                  => 'nullable',
            'npoptkp'                 => 'nullable',
            'nilai_bphtb'             => 'nullable',
            'dph_nik'                 => 'nullable',
            'dph_id_provinsi'         => 'nullable',
            'dph_id_kabupaten'        => 'nullable',
            'dph_id_kecamatan'        => 'nullable',
            'dph_id_kelurahan'        => 'nullable',
            'pengurangan'             => 'nullable',
            'no_sts'                  => 'nullable',
            'njop_tanah'              => 'nullable',
            'njop_bangunan'           => 'nullable',
            'nilai_bphtb_pengurangan' => 'nullable',
            'npop'                    => 'nullable'
        ];
    }
}
